...
{ /*vcast_internal_start*/
extern unsigned long  P_9_7_1;
extern unsigned char  P_9_7_2;
extern unsigned long  R_9_7;
extern unsigned char SBF_9_7;
if(SBF_9_7) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_3972984874
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_3972984874
  if ( vcast_is_in_driver ) {
    P_9_7_1 = value;
    P_9_7_2 = bits;
    vCAST_COMMON_STUB_PROC_9( 9, 7, 3, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_3972984874
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_3972984874
  vCAST_USER_CODE_TIMER_START();
  return R_9_7;
}
{ /*vcast_internal_end*/
    U8 u8t_bits = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,0,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,0),(U8)(bits % ( U8 )32U)));
    U32 u32t_result = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,1),value);
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(u8t_bits != ( U8 )0U)))
    {
...
static void s_sha256_transform(SHA256_CTX *ctx, const U8 data[])
{ /*vcast_internal_start*/
extern SHA256_CTX  *P_9_8_1;
extern vCAST_boolean P_9_8_2_set;
extern unsigned char  *P_9_8_2;
extern unsigned char SBF_9_8;
if(SBF_9_8) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_1350531330
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_1350531330
  if ( vcast_is_in_driver ) {
    P_9_8_1 = ctx;
    P_9_8_2 = ((unsigned char  *)(data));
    vCAST_COMMON_STUB_PROC_9( 9, 8, 3, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_1350531330
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_1350531330
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
...
for (i = ( U32 )0U;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,(VCAST_CONDITION_TYP)(i < ( U32 )16U)); i++)
	{
...
m[i] = ((U32)data[j] << 24U) | ((U32)data[j + 1U] << 16U) | ((U32)data[j + 2U] << 8U) | ((U32)data[j + 3U]);
	...
	for ( ;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,(VCAST_CONDITION_TYP)(i < ( U32 )64U)); i++)
	{
...
a = ctx->state[0]; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,8);
b = ctx->state[1]; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,9);
c = ctx->state[2]; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,10);
d = ctx->state[3];
	VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,11);
e = ctx->state[4]; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,12);
f = ctx->state[5]; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,13);
g = ctx->state[6]; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,14);
h = ctx->state[7];
	for (i = ( U32 )0U;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,(VCAST_CONDITION_TYP)(i < ( U32 )64U)); i++) {
...
h = g; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,18);
g = f; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,19);
f = e; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,20);
e = ((U32)((U32)(d) + (U32)(t1))); VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,21);
d = c; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,22);
c = b; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,23);
b = a; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,24);
a = ((U32)((U32)(t1) + (U32)(t2)));
	}
...
static void s_sha256_init(SHA256_CTX *ctx)
{ /*vcast_internal_start*/
extern SHA256_CTX  *P_9_9_1;
extern unsigned char SBF_9_9;
if(SBF_9_9) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_447622931
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_447622931
  if ( vcast_is_in_driver ) {
    P_9_9_1 = ctx;
    vCAST_COMMON_STUB_PROC_9( 9, 9, 2, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_447622931
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_447622931
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
...
ctx->state[0] = 0x6a09e667U; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,35);
ctx->state[1] = 0xbb67ae85U; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,36);
ctx->state[2] = 0x3c6ef372U;
	VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,37);
ctx->state[3] = 0xa54ff53aU; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,38);
ctx->state[4] = 0x510e527fU; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,39);
ctx->state[5] = 0x9b05688cU;
	VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,40);
ctx->state[6] = 0x1f83d9abU; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,41);
ctx->state[7] = 0x5be0cd19U;
} /*vcast_internal_start*/}/*vcast_internal_end*/
static void s_sha256_update(SHA256_CTX *ctx,  const U8 *data, U32 len)
{ /*vcast_internal_start*/
extern SHA256_CTX  *P_9_10_1;
extern unsigned char  *P_9_10_2;
extern unsigned long  P_9_10_3;
extern unsigned char SBF_9_10;
if(SBF_9_10) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_3190755322
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_3190755322
  if ( vcast_is_in_driver ) {
    P_9_10_1 = ctx;
    P_9_10_2 = ((unsigned char  *)(data));
    P_9_10_3 = len;
    vCAST_COMMON_STUB_PROC_9( 9, 10, 4, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_3190755322
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_3190755322
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
    VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,7,1);
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,8,(VCAST_CONDITION_TYP)(len != ( U32 )0U))) {
        U32 i;
        U32 buffer_idx;
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,42);
buffer_idx = (U32)((ctx->bitcount / 8ULL) % 64ULL);
        for (i = ( U32 )0U;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,9,(VCAST_CONDITION_TYP)(i < len)); i++) {
...
buffer_idx++;
            if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,10,(VCAST_CONDITION_TYP)(buffer_idx == ( U32 )64U))) {
...
buffer_idx = ( U32 )0U;
            ...
            if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,11,(VCAST_CONDITION_TYP)(((i + ( U32 )1U) & ( U32 )0x1FFFU) == 0U))) {
                if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,12,(VCAST_CONDITION_TYP)(s_progress_callback != ((void *)0)))) {
...
static void s_sha256_final(SHA256_CTX *ctx,  U8 *hash)
{ /*vcast_internal_start*/
extern SHA256_CTX  *P_9_11_1;
extern unsigned char  *P_9_11_2;
extern unsigned char SBF_9_11;
if(SBF_9_11) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_1071608566
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_1071608566
  if ( vcast_is_in_driver ) {
    P_9_11_1 = ctx;
    P_9_11_2 = hash;
    vCAST_COMMON_STUB_PROC_9( 9, 11, 3, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_1071608566
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_1071608566
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
	U32 i, j;
	U32 buffer_idx = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,13,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,49),(U32)((ctx->bitcount / 8ULL) % 64ULL)));
...
buffer_idx++;
	if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,14,(VCAST_CONDITION_TYP)(buffer_idx > ( U32 )56U))) {
        while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,15,(VCAST_CONDITION_TYP)(buffer_idx < ( U32 )64U))) { VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,52);
ctx->buffer[buffer_idx] = 0x00U; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,53);
buffer_idx++; }
...
buffer_idx = 0U;
	...
	while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,16,(VCAST_CONDITION_TYP)(buffer_idx < ( U32 )56U))) { VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,56);
ctx->buffer[buffer_idx] = 0x00U; VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,57);
buffer_idx++; }
	{
		U32 bits = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,58),( U32 )(ctx->bitcount));
...
ctx->buffer[58] = 0x00U;
		VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,62);
ctx->buffer[59] = 0x00U;
...
s_sha256_transform(ctx, ctx->buffer);
    for (i = ( U32 )0U;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,17,(VCAST_CONDITION_TYP)(i < ( U32 )8U)); i++) {
...
if(SBF_9_12) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_1805000075
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_1805000075
  if ( vcast_is_in_driver ) {
    vCAST_COMMON_STUB_PROC_9( 9, 12, 1, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_1805000075
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_1805000075
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
    U8 u8t_Index;
    VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,18,1);
for (u8t_Index = 0U;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,19,(VCAST_CONDITION_TYP)(u8t_Index < ( U8 )32U)); u8t_Index++) {
...
if(SBF_9_13) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_1851294136
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_1851294136
  if ( vcast_is_in_driver ) {
    vCAST_COMMON_STUB_PROC_9( 9, 13, 1, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_1851294136
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_1851294136
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
    VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,20,1);
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,21,(VCAST_CONDITION_TYP)((s_nb_state == E_LIB_SHA256_NB_STATE_IDLE) ||
...
s_Sha256_Hash_Init();
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,75);
...
if(SBF_9_14) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_2544131918
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_2544131918
  if ( vcast_is_in_driver ) {
    vCAST_COMMON_STUB_PROC_9( 9, 14, 1, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_2544131918
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_2544131918
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
...
s_nb_process_count++;
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,23,(VCAST_CONDITION_TYP)(s_nb_process_count > ( U32 )5000))) {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,78);
s_nb_state = E_LIB_SHA256_NB_STATE_ERROR;
    }
    else
    {
        E_LIB_SHA256_NB_STATE local_state = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,79),s_nb_state);
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,80);
vcast_switch_taken_1 = 0;
switch (local_state) {
            case E_LIB_SHA256_NB_STATE_INIT:VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,24,1);vcast_switch_taken_1 = 1;
...
s_nb_p_data = ( const U8 *)(void *)(0xFE0000UL);
                VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,83);
s_nb_data_len = (U32)((0xFFA000UL) - (0xFE0000UL));
                if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,25,(VCAST_CONDITION_TYP)((s_nb_data_len == 0U) || (s_nb_data_len > 0x100000UL)))) {   
...
break;
            case E_LIB_SHA256_NB_STATE_UPDATE:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,26,1);vcast_switch_taken_1 = 1;
                VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,89);
u16g_Sha256_Hash_Update_Count++;
                if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,27,(VCAST_CONDITION_TYP)(s_nb_processed_len < s_nb_data_len))) {
                    U32 len_to_process = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,90),s_nb_data_len - s_nb_processed_len);
                    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,28,(VCAST_CONDITION_TYP)(len_to_process > ( U32 )64))) {
                        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,91);
len_to_process = ( U32 )64;
                    }
                    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,29,(VCAST_CONDITION_TYP)(((s_nb_p_data + s_nb_processed_len) + len_to_process) >
                        ( const U8 *)(0xFFA000UL)))) {
...
break;
            case E_LIB_SHA256_NB_STATE_FINAL:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,30,1);vcast_switch_taken_1 = 1;
...
break;
            case E_LIB_SHA256_NB_STATE_IDLE:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,31,1);vcast_switch_taken_1 = 1;
            case E_LIB_SHA256_NB_STATE_DONE:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,32,1);vcast_switch_taken_1 = 1;
            case E_LIB_SHA256_NB_STATE_ERROR:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,33,1);vcast_switch_taken_1 = 1;
            default:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,34,1);vcast_switch_taken_1 = 1;
...
E_LIB_SHA256_NB_STATE g_Lib_Sha256_Nb_GetState(void)
{ /*vcast_internal_start*/
extern E_LIB_SHA256_NB_STATE  R_9_15;
extern unsigned char SBF_9_15;
if(SBF_9_15) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_3663246109
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_3663246109
  if ( vcast_is_in_driver ) {
    vCAST_COMMON_STUB_PROC_9( 9, 15, 1, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_3663246109
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_3663246109
  vCAST_USER_CODE_TIMER_START();
  return R_9_15;
}
{ /*vcast_internal_end*/
    VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,35,1);
...
if(SBF_9_16) {
  vCAST_USER_CODE_TIMER_STOP();
#define BEGINNING_OF_STUB_USER_CODE_9_2713480058
#include "vcast_configure_stub.c"
#undef BEGINNING_OF_STUB_USER_CODE_9_2713480058
  if ( vcast_is_in_driver ) {
    vCAST_COMMON_STUB_PROC_9( 9, 16, 1, 0 );
  } /* vcast_is_in_driver */
#define END_OF_STUB_USER_CODE_9_2713480058
#include "vcast_configure_stub.c"
#undef END_OF_STUB_USER_CODE_9_2713480058
  vCAST_USER_CODE_TIMER_START();
  return;
}
{ /*vcast_internal_end*/
    VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,36,1);
