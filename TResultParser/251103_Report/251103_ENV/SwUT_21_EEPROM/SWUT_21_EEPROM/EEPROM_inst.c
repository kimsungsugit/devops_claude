...
ValidFrom = From;
  if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(ValidFrom > (word)2U))) {   
...
ValidTo = To;
  if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,(VCAST_CONDITION_TYP)(ValidTo > (word)4U))) {   
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,3);
ValidTo = (word)4U;
  }
  for (i = ValidFrom;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,(VCAST_CONDITION_TYP)(i < ValidTo)); i = (word)(i + 2U)) {
    word index = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,4),i/2U);
...
{ /*vcast_internal_end*/
  byte result = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,6),0U));
  byte err = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,7),0U);
  word i;
  byte j;
  dword PhraseAddr;
  if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,(VCAST_CONDITION_TYP)(From != To))) {
...
PhraseAddr = (dword)Addr;
    while( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,6,(VCAST_CONDITION_TYP)((i < To) && (result == (byte)0U)))) {
      byte setupResult = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,10),SetupFCCOB(PhraseAddr, From, To, Data, &i));
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,11);
_FSTAT . Byte = 0x80U;                      
      while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,7,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,12);
;  
      }
      if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,8,(VCAST_CONDITION_TYP)((_FSTAT . Byte & (byte)0x30U) != (byte)0U))) {        
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,13);
result = 9U;            
      } else if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,9,(VCAST_CONDITION_TYP)(_FSTAT . MergedBits . grpMGSTAT != (byte)0U))) {          
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,14);
err = 1U;                         
      } else {
      }
      if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,10,(VCAST_CONDITION_TYP)(PhraseAddr <= (0xFFFFFFFFUL - (dword)8U)))) {
...
result = 9U;
    ...
    if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,11,(VCAST_CONDITION_TYP)((result == (byte)0U) && (err != (byte)0U)))) {
...
{ /*vcast_internal_end*/
  byte j;
  word i = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,12,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,19),*pIndex));
...
_FCCOB1 . Word = (word)(PhraseAddr & (dword)0xFFFFU);          
  for(j = (byte)0U;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,13,(VCAST_CONDITION_TYP)(j < (byte)4U)); j++) {
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,25);
*((volatile word*)&_FCCOB2 . Word + j) = *(( word *)(Data + (i/2U)));  
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,14,(VCAST_CONDITION_TYP)(i <= (0xFFFFU - 2U)))) {
...
i = To;  
    ...
    if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,15,(VCAST_CONDITION_TYP)(i >= To))) {
...
{ /*vcast_internal_end*/
  byte result = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,16,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,32),0U));
  if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,17,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {               
...
_FSTAT . Byte = 0x80U;                      
    while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,18,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,40);
;  
    }
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,19,(VCAST_CONDITION_TYP)((_FSTAT . Byte & (byte)0x23U) != (byte)0U))) {        
...
{ /*vcast_internal_end*/
  byte result = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,20,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,43),0U));
  if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,21,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {               
...
_FSTAT . Byte = 0x80U;                      
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,22,(VCAST_CONDITION_TYP)((_FSTAT . Byte & (byte)0x30U) != (byte)0U))) {        
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,52);
result = 9U;            
    } else {
      while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,23,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,53);
;  
      }
      if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,24,(VCAST_CONDITION_TYP)(_FSTAT . MergedBits . grpMGSTAT != (byte)0U))) {               
...
{ /*vcast_internal_end*/
  ...
  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,25,1);
if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,26,(VCAST_CONDITION_TYP)(((dword)Addr < (dword)((EEPROM_TAddress)0x00100000UL)) || ((dword)Addr > (dword)((EEPROM_TAddress)0x001003FFUL))))) {  
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,56);
result = 2U;                 
  } else if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,27,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {              
...
SecAddr = (EEPROM_TAddress_)((dword)Addr & 0x00FFFFFEUL);  
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,28,(VCAST_CONDITION_TYP)(*SecAddr == 0xFFFFU))) {  
      if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,29,(VCAST_CONDITION_TYP)((((dword)Addr) & (dword)1U) != (dword)0U))) {         
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,59);
result = WriteWord(SecAddr, ((*SecAddr) & 0xFF00U) | Data);
      } else {
        word tempWord = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,60),*Addr);
        byte nextByte = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,61),(byte)(tempWord & 0xFFU));
...
Data16 = BackupArray[(((dword)Addr) % (dword)0x04U) / (dword)2U];  
      if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,30,(VCAST_CONDITION_TYP)((((dword)Addr) & (dword)1U) != (dword)0U))) {         
...
err = EraseSectorInternal(Addr);  
      if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,31,(VCAST_CONDITION_TYP)(err != (byte)0U))) {
...
{ /*vcast_internal_end*/
  byte result = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,32,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,74),0U));
  if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,33,(VCAST_CONDITION_TYP)(((dword)Addr < (dword)((EEPROM_TAddress)0x00100000UL)) || ((dword)Addr > (dword)((EEPROM_TAddress)0x001003FFUL))))) {  
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,75);
result = 2U;                 
  } else if( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,34,(VCAST_CONDITION_TYP)(_FSTAT . Bits . CCIF == (byte)0U))) {              
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,76);
result = 8U;                  
  } else {
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,35,(VCAST_CONDITION_TYP)((((dword)Addr) & (dword)1U) != (dword)0U))) {
      EEPROM_TAddress_ alignedAddr = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,77),(EEPROM_TAddress_)((dword)Addr & 0xFFFFFFFEUL));
      word tempWord = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,78),*alignedAddr);
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,79);
*Data = (byte)(tempWord & 0xFFU);   
    } else {
      word tempWord = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,80),*Addr);
