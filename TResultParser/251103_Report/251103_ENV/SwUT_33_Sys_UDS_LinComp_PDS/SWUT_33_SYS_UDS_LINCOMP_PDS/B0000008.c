 ...
 *
 * Path: C:/MDS_work/PSD_ENV/UT/SwUT_33_Sys_UDS_LinComp_PDS/SWUT_33_SYS_UDS_LINCOMP_PDS/S0000008.c
 *
 * Type: not-stubbed
 *
 * Unit Number: 8
    ...
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        ...
        case 3: /* for global object VECTORCAST_INT3 */
          ...
          break;
        case 4: /* for global object VECTORCAST_STR1 */
          VCAST_TI_8_2 ( VECTORCAST_STR1);
          break;
        case 5: /* for global object VECTORCAST_BUFFER */
          VCAST_TI_8_4 ( VECTORCAST_BUFFER);
          break;
        default:
...
/* An array */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_2 ( char  vcast_param[8] ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_2 */
...
{
  {
    int VCAST_TI_8_2_array_index = 0;
    int VCAST_TI_8_2_index = 0;
    int VCAST_TI_8_2_first, VCAST_TI_8_2_last;
    int VCAST_TI_8_2_local_field = 0;
    int VCAST_TI_8_2_value_printed = 0;
    int VCAST_TI_8_2_is_string = (VCAST_FIND_INDEX()==-1);

    vcast_get_range_value (&VCAST_TI_8_2_first, &VCAST_TI_8_2_last);
    VCAST_TI_8_2_local_field = vCAST_DATA_FIELD;
    {
      int VCAST_TI_8_2_upper = 8;
      for (VCAST_TI_8_2_array_index=0; VCAST_TI_8_2_array_index< VCAST_TI_8_2_upper; VCAST_TI_8_2_array_index++){
        if ( (VCAST_TI_8_2_index >= VCAST_TI_8_2_first) && ( VCAST_TI_8_2_index <= VCAST_TI_8_2_last)){
          if ( VCAST_TI_8_2_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, 1,VCAST_TI_8_2_upper);
          else
            VCAST_TI_8_3 ( &(vcast_param[VCAST_TI_8_2_index]));
          VCAST_TI_8_2_value_printed = 1;
          vCAST_DATA_FIELD = VCAST_TI_8_2_local_field;
        } /* if */
        if (VCAST_TI_8_2_index >= VCAST_TI_8_2_last)
          break;
        VCAST_TI_8_2_index++;
      } /* loop */
      if ((vCAST_COMMAND == vCAST_PRINT)&&(!VCAST_TI_8_2_value_printed))
...
/* An array */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_4 ( int  vcast_param[4] ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_4 */
...
/* An integer */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_3 ( char  *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_3 */
...
#define VCAST_TI_VECTOR_TYPE "NEW_VECTOR\n"
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  /* Range Data for TI (array) VCAST_TI_8_2 */
