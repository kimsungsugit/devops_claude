# 1 "vcast_preprocess.22756.1010.c"
# 1 "vcast_preprocess.22756.1008.c"

typedef int VECTORCAST_MARKER__UNIT_PREFIX_START;

typedef int VECTORCAST_MARKER__UNIT_PREFIX_END;
# 1 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
...
# 31 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
# 37 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"


 
 
 
# 59 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"

 
# 84 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
...
# 165 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
...
# 204 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
...
{ /*vcast_internal_end*/
    ...
    if( ( U16 )u8s_DidMsb == ( U16 )( ( U8 )( 0xF1U ) ) )
    {
        u16t_LocalDidLsb = ( U16 )u8s_DidLsb;
        s_UDS_RDBI_ProcessSystemInfo(u16t_LocalDidLsb);
    }
    else if( ( U16 )u8s_DidMsb == ( U16 )( ( U8 )( 0xC2U ) ) )
    {
        u16t_LocalDidLsb = ( U16 )u8s_DidLsb;
        s_UDS_RDBI_ProcessSystemStatus(u16t_LocalDidLsb);
    }
# 248 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
    else
    {    
        ;
    }
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( U16 )( ( U8 )( 0x04U ) ) + ( U16 )( ( U8 )( 0x03U ) );

    for( u16t_EepromAddrIdx = ( ( U8 )( 0x00U ) ); u16t_EepromAddrIdx < ( ( U8 )( 0x04U ) ); u16t_EepromAddrIdx++ )
    { 
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( ( U8 )( 0x0AU ) ) + ( ( U8 )( 0x03U ) );

    for( u8t_EepromAddrIdx = ( ( U8 )( 0x00U ) ); u8t_EepromAddrIdx < ( ( U8 )( 0x0AU ) ); u8t_EepromAddrIdx++ )
    { 
...
{ /*vcast_internal_end*/
    ...
    U8 u8t_EepromAddrIdx;
    U16 u16t_Length = ( ( ( U8 )( 0x06U ) ) - ( ( U8 )( 0x02U ) ))  + ( ( U8 )( 0x03U ) );
...
{ /*vcast_internal_end*/
    ...
    U8 u8t_EepromAddrIdx;
    U8 u8t_Array[( ( U8 )( 0x04U ) )];
    U16 u16t_Length = ( ( U8 )( 0x04U ) ) + ( ( U8 )( 0x03U ) );

    for( u8t_EepromAddrIdx = ( ( U8 )( 0x00U ) ); u8t_EepromAddrIdx < ( ( U8 )( 0x04U ) ); u8t_EepromAddrIdx++ )
    { 
        ...
        case E_LIB_SHA256_NB_STATE_DONE:
            {
                ...
                for (u8t_Index = ( U8 )0U; u8t_Index < ( U8 )32U; u8t_Index++) 
                {
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( ( U8 )( 0x16U ) ) + ( ( U8 )( 0x03U ) );
    U16 u16t_MotorCurrent = ((U16)(((S16)(s16g_ApiIn_MotorCurrLvl) < (S16)0) ? ((U16)(-(S16)(s16g_ApiIn_MotorCurrLvl))) : ((U16)(s16g_ApiIn_MotorCurrLvl))));
...
{ /*vcast_internal_end*/
    ...
    for( u8t_EepromAddrIdx = ( ( U8 )( 0x00U ) ); u8t_EepromAddrIdx < ( ( U8 )( 0x16U ) ); u8t_EepromAddrIdx++ )
    { 
...
{ /*vcast_internal_end*/
    ...
    U8 u8t_PCI = lin_tl_rx_queue.tl_pdu[lin_tl_rx_queue.queue_header][1];
    U8 u8t_FrameType = (u8t_PCI & (U8)0xF0U) >> 4U;
    
    if( u8t_FrameType == (U8)0x00U )  
    {
        u8s_UdsSid = lin_tl_rx_queue.tl_pdu[lin_tl_rx_queue.queue_header][2];
        u8s_DidMsb = lin_tl_rx_queue.tl_pdu[lin_tl_rx_queue.queue_header][3];
        u8s_DidLsb = lin_tl_rx_queue.tl_pdu[lin_tl_rx_queue.queue_header][4];
    ...
    if( u8s_DidMsb == ( ( U8 )( 0xC2U ) ) )
    {
        ...
        case ( ( U8 )( 0xA0U ) ):
            ...
            break;
        default: u8s_DidLsb = ( ( U8 )( 0x00U ) );
            break;
        }
    }
    else if( u8s_DidMsb == (U8)0xF2U )   
    {
         
        if( u8s_DidLsb == (U8)0xF1U )   
        {
...
{ /*vcast_internal_end*/
    ...
    U8 u8t_TempData;
    U16 u16t_Length = ( ( U8 )( 0x03U ) );

    u8t_TempData = ( lin_tl_rx_queue.tl_pdu[0][6] & ( U8 )0x01U );
    if( u8t_TempData == ( ( U8 )( 0x01U ) ) )
    {
...
{ /*vcast_internal_end*/
    ...
    if( u8s_UserServiceIdMsb == ( ( U8 )( 0xF1U ) ) )
    {
        s_UDS_WDBI_UsOpt_F1G( );
    }
    else if( ( u8s_UserServiceIdMsb == ( ( U8 )( 0xE2U ) ) )
...
{ /*vcast_internal_end*/
    ...
    case ( ( U8 )( 0xA6U ) ):
        ...
        break;          
    default: u8s_UserServiceIdLsb = ( ( U8 )( 0x00U ) );
        break;
    }
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = 0x05U;

    for( u8t_LinRxDatabuffIdx = ( ( U8 )( 0x00U ) ); u8t_LinRxDatabuffIdx < ( ( U8 )( 0x04U ) ); u8t_LinRxDatabuffIdx++ )
    {
        u8t_FrameCnt = (U8)1U;
...
{ /*vcast_internal_end*/
    ...
    for( u8t_LinRxDatabuffIdx = ( ( U8 )( 0x00U ) ); u8t_LinRxDatabuffIdx < ( ( U8 )( 0x0AU ) ); u8t_LinRxDatabuffIdx++ )
    {
        if( u8t_LinRxDatabuffIdx < ( ( U8 )( 0x06U ) ) )
        {
            u8t_FrameCnt = (U8)1U;
            u8g_SysUds_WriteData[u8t_LinRxDatabuffIdx] = lin_tl_rx_queue.tl_pdu[u8t_FrameCnt][u8t_LinRxDatabuffIdx + ( U8 )2U];
        }
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( ( U8 )( 0x05U ) ) + ( ( U8 )( 0x03U ) );
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( ( U8 )( 0x02U ) ) + ( ( U8 )( 0x03U ) );
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( ( U8 )( 0x14U ) ) + ( ( U8 )( 0x03U ) ) ;
    U16 u16t_MotorCurrent;

    u16t_MotorCurrent = ((U16)(((S16)(s16g_ApiIn_MotorCurrLvl) < (S16)0) ? ((U16)(-(S16)(s16g_ApiIn_MotorCurrLvl))) : ((U16)(s16g_ApiIn_MotorCurrLvl))));
...
{ /*vcast_internal_end*/
    ...
    U16 u16t_Length = ( ( U8 )( 0x08U ) ) + ( ( U8 )( 0x03U ) );
    U16 u16t_Temp;

    if( s16g_ApiIn_MotorPosition >= ( ( S16 )( 0x0000 ) ) )
    {
...
{ /*vcast_internal_end*/
    ...
    if( ( u8t_Data1 != u8g_SysEepromCtrl_SleepMode )
    &&  ( u8t_Data1 == ( ( U8 )( 0x00U ) ) ) )
    {
    ...
    else if( ( u8t_Data2 != u8g_SysEepromCtrl_MotorA1A2Output )
         &&  ( u8t_Data2 == ( ( U8 )( 0x00U ) ) ) )
    {
        u8g_SysUds_WriteData[0] = ( U8 )( ( U16 )( 100U ) );
...
{ /*vcast_internal_end*/
    ...
    U8 u8t_ReadData[4];
    U16 u16t_Length = ( U16 )( ( U8 )8U + ( ( U8 )( 0x03U ) ) );
...
# 1754 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"

# 1820 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"

# 1924 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
...
# 2334 "C:/workspace/NE1AW_PORTING/Sources/SYSTEM/Sys_UDS_LinComp_PDS.c"
...
# 6 "vcast_preprocess.22756.1008.c"
...
# 2 "vcast_preprocess.22756.1010.c"
