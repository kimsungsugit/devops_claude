"""SwIT (Software Integration Test) Coverage Report 빌더 메타 (33차 라운드).
...
Hyundai v2.02 양식 호환:
    `doc_id_base="HDPDM01-SwIT"` (SwUT는 "HDPDM01-SUT"). Cover 시트 Doc. ID
    필드에 `{doc_id_base}-{doc_id_sequence}` 형식으로 채움.
"""
