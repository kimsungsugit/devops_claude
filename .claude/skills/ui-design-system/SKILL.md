...
## 대상 파일
- `frontend/src/App.css` (4,500+ 줄)
- `frontend/src/App.jsx` (5,015 줄)
- `frontend/src/views/` 내 리포트 뷰들
...
```bash
# 하드코딩 컬러 탐색
grep -rn "#[0-9a-fA-F]\{3,6\}" frontend/src/ --include="*.css" --include="*.jsx"
grep -rn "rgb(" frontend/src/ --include="*.css" --include="*.jsx"
```
...
```bash
# 하드코딩 컬러 잔존 확인
grep -rn "#[0-9a-fA-F]\{6\}" frontend/src/App.css | wc -l  # 목표: 0
