...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--do-coverage", action="store_true", help="Enable Code Coverage (gcovr)")
    ...
    parser.add_argument("--enable-domain-tests", action="store_true", help="Enable Domain Tests")
